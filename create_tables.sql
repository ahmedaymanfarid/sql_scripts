...
CREATE TABLE [dbo].[model_specs]	(	[date_added] [datetime] NULL,
										[added_by] [int] NULL,
										...
										[genset_rated_power] [decimal](18, 0) NULL,
										[genset_rating_unit] [int] NULL,
										[genset_ltb_50] [decimal](18, 0) NULL,
										[genset_ltb_50_unit] [int] NULL,
										[genset_ltb_60] [decimal](18, 0) NULL,
										[genset_ltb_60_unit] [int] NULL,
										[genset_prp_50] [decimal](18, 0) NULL,
										[genset_prp_50_unit] [int] NULL,
										[genset_prp_60] [decimal](18, 0) NULL,
										[genset_prp_60_unit] [int] NULL,
										[genset_cooling] [varchar](250) NULL,
										[genset_tank] [varchar](250) NULL,
										[genset_load] [varchar](250) NULL,
										[genset_alternator] [varchar](250) NULL,
										[ups_io_phase] [varchar](50) NULL,
										[ups_rated_power] [decimal](18, 0) NULL,
										[ups_rating] [int] NULL,
										[ups_backup_time_50] [int] NULL,
										[ups_backup_time_70] [int] NULL,
										[ups_backup_time_100] [int] NULL,
										[ups_input_power_factor] [varchar](250) NULL,
										[ups_thdi] [varchar](250) NULL,
										[ups_input_nominal_voltage] [varchar](250) NULL,
										[ups_input_voltage] [varchar](250) NULL,
										[ups_voltage_tolerance] [varchar](250) NULL,
										[ups_output_power_factor] [varchar](250) NULL,
										[ups_thdv] [varchar](250) NULL,
										[ups_output_nominal_voltage] [varchar](250) NULL,
										[ups_output_dc_voltage_range] [varchar](250) NULL,
										[ups_overload_capability] [varchar](250) NULL,
										[ups_efficiency] [varchar](50) NULL,
										[ups_input_connection_type] [varchar](250) NULL,
										[ups_front_panel] [varchar](250) NULL,
										[ups_max_power] [varchar](250) NULL,
										[ups_certificates] [varchar](250) NULL,
										[ups_safety] [varchar](250) NULL,
										[ups_emc] [varchar](405) NULL,
										[ups_environmental_aspects] [varchar](250) NULL,
										[ups_test_performance] [varchar](250) NULL,
										[ups_protection_degree] [varchar](250) NULL,
										[ups_transfer_voltage_limit] [varchar](250) NULL,
										[ups_marking] [varchar](50) NULL,
										[is_valid] [bit] NULL,
										[valid_until] [datetime] NULL,
										[panel_type] [varchar](50) NULL,
										[panel_power_rate] [varchar](50) NULL,
										[panel_power_rate_unit] [int] NULL,
										[panel_circuit_breaker_rate] [varchar](50) NULL,
										[panel_circuit_breaker_rate_unit] [int] NULL,
										[panel_phase] [varchar](250) NULL,
										[panel_pole] [int] NULL,
										[breaker_type] [varchar](50) NULL,
										[breaker_short_circuit_rating] [varchar](50) NULL,
										[breaker_short_circuit_rate_unit] [int] NULL,
										[breaker_currentt_rating] [varchar](50) NULL,
										[breaker_current_rate_unit] [int] NULL,
										[breaker_pole] [int] NULL,
										[breaker_curve] [varchar](10) NULL,
										[oil_sector] [varchar](50) NULL,
										[oil_viscosity] [varchar](50) NULL,
										[oil_packaging] [varchar](50) NULL,
										[oil_packaging_unit] [int] NULL,
										[oil_class] [varchar](250) NULL,
										[oil_specifications] [varchar](450) NULL,
										[oil_product_code] [varchar](50) NULL,
										[breacker_iec_standard] [varchar](100) NULL,											
										FOREIGN KEY(product_id, brand_id, model_id) REFERENCES erp_system.dbo.brands_models (product_id, brand_id, model_id),
